<template>
    <div class="w-container relative  max-w-7xl mx-auto px-24 w-full pt-12 pb-9 flex justify-center flex-col lg:px-4  md:mx-0">
        <div class="relative min-h-[640px] flex flex-col justify-start items-center pt-16 bg-cover bg-bottom rounded-[48px] bg-[#111827] bg-feature-hero-2">
            <h2 class=" text-white mb-4 text-center text-[54px]  tracking-[-0.01em] font-bold leading-[68px]">Ready to write at&nbsp;the speed of&nbsp;light?</h2>
            <p class="text-[#ffffffcc] mb-10 text-[18px] text-center mt-0 ">See how easy it can be&nbsp;to&nbsp;write&nbsp;amazing content.</p>
            <Button class="bg-[#ff76df] hover:bg-[#ff97e7] text-xl" title="Get Started for Free" />
            <div class="block-banner-icon absolute top-auto h-[360px] left-0 right-0 bottom-0">
